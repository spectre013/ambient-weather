...
async function update(data) {
    if(!Object.prototype.hasOwnProperty.call("lightning_time",data)) {
        data.lightning_time = 1594158329000
        data.lightning_distance = 6.45
    }
    ...
    let insertData = {
        ...
        lightningtime: moment(data.lightning_time).local().format("YYYY-MM-DD HH:mm:ss"),
...
async function updateStatistics() {
    ...
    const fields = ['tempf','tempinf','temp1f','temp2f','baromrelin','uv','humidity','windspeedmph','windgustmph','dewpoint','humidityin','humidity1','humidity2','dailyrainin'];
        ...
        periods.forEach((period) => {
            types.forEach((type) => {
                fields.forEach((field) => {
                    ...
                    if ((field === "dailyrainin" && type === "MAX") || field !== "dailyrainin") {
