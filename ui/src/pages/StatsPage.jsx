  ...
  return (
    <article className="page stats-page">
      <header className="page-head">
        ...
        <h1 className="page-title">Weather Stats.</h1>
        <p className="page-dek">
          Zoms Weather is run off an <a
            href="https://ambientweather.com/ws-5000-ultrasonic-smart-weather-station">Ambient Weather WS-5000</a> located about 10 meters off the ground.
          The first data was from around 2018 and has been through several iterations, the first was VueJS with a Golang back end. In 2020 the site was switched
          to React and Golang. The third iteration was a complete UI rework and done with Golang and HTMX. The current version has moved back to React with a
          Golang back end.</p>
      </header>
