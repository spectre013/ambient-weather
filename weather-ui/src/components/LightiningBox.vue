...
<!--      </span>-->
    ...
    <div id="lightning-container" v-if="current && lightning">
      ...
      <div id="lightning">
        <div class="sunblock">
          <div class="button button-dial-small">
            ...
            <div class="button-dial-label-small">{{ props.current.lightninghour }}</div>
          </div>
          <laststrike>
            Last Strike
            <br />{{ lightningFormat(props.current.lightningtime) }} <br />
            {{ props.current.lightningdistance }} Miles away
          </laststrike>
        </div>
        <div class="sunblock">
          <div class="button button-dial-small">
            ...
            <div class="button-dial-top-small"></div>
            <div class="button-dial-label-small">{{ props.current.lightningday }}</div>
          </div>
        </div>
        <div class="sunblock">
          <div class="button button-dial-small">
      ...
      <div class="lightningyear-mod2">
        Strikes {{ month(props.current.date) }} <orange> {{ lightning.max.month.value }}</orange>
      </div>
      <div class="lightningmonth-mod2">
        Strikes {{ year(props.current.date) }} <orange> {{ lightning.max.year.value }}</orange>
      </div>
    </div>
  </div>
</template>
