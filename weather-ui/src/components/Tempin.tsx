...
const Tempin = (props:Props) => {
    ...
    return (
        <BoxData icon={'&#xF053;'} title={props.area} unit="&deg;F" style={{}}>
            <>
                <div className="tempin-container">
                    ...
                    <div className="maxin">Max: {weather.tempDisplay(minmax.max.day.value, props.units)}&deg;</div>
                    <div className="minin">Min: {weather.tempDisplay(minmax.min.day.value, props.units)}&deg;</div>
                </div>
            </>
        </BoxData>
    )
