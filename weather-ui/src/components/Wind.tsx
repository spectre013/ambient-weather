...
const WindBox = (props:Props) => {
    ...
    function beaufortScale() {
        const beaufortValue = getBeaufort();
    ...
    return (
        <BoxData icon="fa-wind" title="Wind" unit="MPH">
            <div className="wind-container">
                <div className="bft">
                    <div><span className={beaufortClass()}><BeaufortSvg /></span> &nbsp;{ getBeaufort() }
                        <span className="bfttxt">&nbsp;BFT</span>
                    </div>
                    <div>
                        { beaufortText() }
                    </div>
                ...
                <div className="windrun">
                    ...
                    <div>
                        <img src={WindRun} height={9} width={9} alt="Wind RUn" />
                        &nbsp;{ weather.windDisplay(windRun(), props.units) } mi
                    </div>
                </div>
