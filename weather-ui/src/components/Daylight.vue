<template>
    <div class="weather-item">
        <div class="chartforecast">
            <span class="yearpopup"><a alt="meteor showers" title="meteor showers" href="meteorshowers.php" data-lity=""><svg width="10px" height="10px" viewBox="0 0 16 16"><path fill="currentcolor" d="M0 0l14.527 13.615s.274.382-.081.764c-.355.382-.82.055-.82.055L0 0zm4.315 1.364l11.277 10.368s.274.382-.081.764c-.355.382-.82.055-.82.055L4.315 1.364zm-3.032 2.92l11.278 10.368s.273.382-.082.764c-.355.382-.819.054-.819.054L1.283 4.284zm6.679-1.747l7.88 7.244s.19.267-.058.534-.572.038-.572.038l-7.25-7.816zm-5.68 5.13l7.88 7.244s.19.266-.058.533-.572.038-.572.038l-7.25-7.815zm9.406-3.438l3.597 3.285s.094.125-.029.25c-.122.125-.283.018-.283.018L11.688 4.23zm-7.592 7.04l3.597 3.285s.095.125-.028.25-.283.018-.283.018l-3.286-3.553z"></path></svg> &nbsp;Perseids Meteor</a></span><span class="yearpopup"><a alt="aurora information" title="aurora information" href="aurora.php" data-lity=""><svg id="i-info" viewBox="0 0 32 32" width="9" height="9" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%"><path d="M16 14 L16 23 M16 8 L16 10"></path><circle cx="16" cy="16" r="14"></circle></svg> Aurora </a></span>
        </div>
        <span class="moduletitle">Daylight | Darkness</span><br>
        <div id="moonphase" v-if="astro">

            <div class="updatedtime1"><svg id="i-info" viewBox="0 0 32 32" width="6" height="6" fill="#9aba2f" stroke="#9aba2f" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%"><path d="M16 14 L16 23 M16 8 L16 10"></path><circle cx="16" cy="16" r="14"></circle>
            </svg> {{ now }}</div>
            <div class="daylightmoduleposition">

                <div class="weather34sunlightday">
                     {{ astro.day_length }}<weather34daylightdaycircle></weather34daylightdaycircle> hrs<br>Total Daylight
                </div>
                <div class="weather34sundarkday">{{ darkness }} <weather34darkdaycircle></weather34darkdaycircle> hrs <br>Total Darkness</div>

                <div class="weather34sunriseday"><svg id="weather34 sunrise" width="8pt" height="8pt" viewBox="0 0 200 120" version="1.1" xmlns="http://www.w3.org/2000/svg"><path fill="#ff8841" opacity="1.00" d=" M 73.12 50.01 C 90.23 43.20 110.01 43.20 127.10 50.08 C 134.54 53.53 141.90 57.50 148.03 63.03 C 154.51 69.43 160.41 76.59 164.39 84.84 C 168.81 94.26 171.40 104.57 171.60 114.99 C 123.86 115.00 76.13 115.01 28.40 114.99 C 28.79 97.79 35.36 80.71 47.17 68.13 C 53.98 59.83 63.50 54.42 73.12 50.01 Z"></path>
                    </svg>Sun Rise<br>{{ todayTomorrow('sunrise') }} {{ astro.sunrise }}<!--<br>First Light (<blueu>04:55</blueu>)--></div>
                <div class="weather34sunsetday"><svg id="weather34 sunset" width="8pt" height="8pt" viewBox="0 0 200 120" version="1.1" xmlns="http://www.w3.org/2000/svg"><path fill="#d65b4a" opacity="1.00" d=" M 28.39 48.01 C 76.13 47.99 123.87 48.00 171.60 48.01 C 171.21 64.95 164.90 81.83 153.35 94.34 C 146.33 103.04 136.44 108.75 126.37 113.22 C 109.44 119.78 89.98 119.71 73.11 112.99 C 63.49 108.57 53.96 103.15 47.15 94.85 C 35.35 82.27 28.80 65.20 28.39 48.01 Z"></path>
                    </svg>Sun Set<br>{{ todayTomorrow('sunset') }} {{ astro.sunset }}<!--<br>Last Light (<blueu>21:24</blueu>)--></div>
                <div class="daylightword">
                    <value>Daylight</value>
                </div>

                <div class="elevationword">
                    <value>Sun Elevation<span>
                        <value>
                            <maxred> {{ astro.sun_altitude.toFixed(2) }}&nbsp;<div :class="sunBelow">&nbsp;</div>
                            </maxred>
                        </value>
                    </span></value>
                </div>
