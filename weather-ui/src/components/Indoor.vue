<template>
    <div class="weather-item">
        <div class="chartforecast">
            <span class="yearpopup"> <a alt="almanac temperature" title="almanac temperature" href="#" v-on:click="openModal('almanac',{tempfield:'temp'+loc+'f','humidfield':'humidity'+loc})" data-lity="">
            ...
            <span class="yearpopup"> <a v-on:click="openModal('chart',{time:'year',type:'temp',field:'temp'+loc+'f'})" alt="Temperature" title="Temperature"  href="#">
            ...
            <span class="todaypopup">
                <a alt="Feels Like" title="Feels Like" href="#" data-lity="" v-on:click="openModal('chart',{time:'month',type:'temp',field:'temp'+loc+'f'})">
                <svg version="1.1" width="8pt" height="8pt" x="0px" y="0px" viewBox="0 0 496 496" style="enable-background:new 0 0 496 496;" xml:space="preserve"><path style="fill:#719FA3;" d="M496,428c0,6.4-5.6,12-12,12H12c-6.4,0-12-5.6-12-12l0,0c0-6.4,5.6-12,12-12h472 C490.4,416,496,421.6,496,428L496,428z"></path><rect x="24" y="56" style="fill:#1589AD;" width="88" height="344"></rect><polyline style="fill:#04567F;" points="24,56 112,56 112,400 "></polyline><rect x="144" y="128" style="fill:#24966A;" width="88" height="272"></rect><polyline style="fill:#007763;" points="144,128 232,128 232,400 "></polyline><rect x="264" y="208" style="fill:#E8961F;" width="88" height="192"></rect><polyline style="fill:#E57520;" points="264,208 352,208 352,400 "></polyline><rect x="384" y="272" style="fill:#D32A0F;" width="88" height="128"></rect><polyline style="fill:#AF1909;" points="384,272 472,272 472,400 "></polyline><g></g></svg>
                {{ 'MMM' | chartDates }} </a></span>
            <span class="todaypopup">
                <a alt="Greenhouse" title="Greenhouse" href="#" data-lity="" v-on:click="openModal('chart',{time:'day',type:'temp',field:'temp'+loc+'f'})">
                    <svg version="1.1" width="8pt" height="8pt" x="0px" y="0px" viewBox="0 0 496 496" style="enable-background:new 0 0 496 496;" xml:space="preserve"><path style="fill:#719FA3;" d="M496,428c0,6.4-5.6,12-12,12H12c-6.4,0-12-5.6-12-12l0,0c0-6.4,5.6-12,12-12h472 C490.4,416,496,421.6,496,428L496,428z"></path><rect x="24" y="56" style="fill:#1589AD;" width="88" height="344"></rect><polyline style="fill:#04567F;" points="24,56 112,56 112,400 "></polyline><rect x="144" y="128" style="fill:#24966A;" width="88" height="272"></rect><polyline style="fill:#007763;" points="144,128 232,128 232,400 "></polyline><rect x="264" y="208" style="fill:#E8961F;" width="88" height="192"></rect><polyline style="fill:#E57520;" points="264,208 352,208 352,400 "></polyline><rect x="384" y="272" style="fill:#D32A0F;" width="88" height="128"></rect><polyline style="fill:#AF1909;" points="384,272 472,272 472,400 "></polyline><g></g></svg>
                Today</a></span>

        </div>
        <span class="moduletitle" v-if="title"> {{title }} (<valuetitleunit>&deg;{{ tempLabel }}</valuetitleunit>) </span><br>
        <div id="temperature"  v-if="live && minmax && trend">
            ...
            <div class="tempcontainer">
                <div class="maxdata">{{ minmax.max.day.value | tempDisplay($store.getters.units)}}&deg; | {{ minmax.min.day.value | tempDisplay($store.getters.units) }}&deg;</div>
                <div class="maxdata"></div>
                <div v-bind:class="temp| tempClass">{{ temp | tempDisplay($store.getters.units) }}<smalltempunit>&deg;{{ tempLabel }}</smalltempunit></div>
            ...
            <div class="heatcircle">
                <div class="heatcircle-content">
                    ...
                    <div class="tempconverter1">
                        <div v-bind:class="humidity | smallTempClass">{{ humidity }}<smalltempunit2>%<smalltempunit2></smalltempunit2>
                        </smalltempunit2>
                        </div>
                    </div>
                </div>
                <div class="heatcircle2">
                    <div class="heatcircle-content">
                        ...
                        <div class="tempconverter1">
                            <div v-bind:class="minmax.avg.day.value | smallTempClass">{{ minmax.avg.day.value | tempDisplay($store.getters.units)}}<smalltempunit2>&deg;{{ tempLabel }}</smalltempunit2>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="heatcircle3">
                    <div class="heatcircle-content">
                        ...
                        <div class="tempconverter1">
                            <div v-bind:class="minmax.max.day.value | smallTempClass">{{ minmax.max.day.value | tempDisplay($store.getters.units) }}<smalltempunit2>&deg;{{ tempLabel }}</smalltempunit2>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="heatcircle4">
                    <div class="heatcircle-content">
                        ...
                        <div class="tempconverter1">
                            <div v-bind:class="minmax.min.day.value | smallTempClass">&nbsp;{{ minmax.min.day.value | tempDisplay($store.getters.units) }}<smalltempunit2>&deg;{{ tempLabel }}</smalltempunit2>&nbsp;</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="tempconverter2">
                <div v-bind:class="temp | tempCircle">{{ temp | toCelcius($store.getters.units) }}<smalltempunit2>&deg;{{ tempLabelAlt }}<smalltempunit2></smalltempunit2>
                </smalltempunit2>
                </div>
            </div>
        </div>
