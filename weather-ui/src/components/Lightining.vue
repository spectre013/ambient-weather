    ...
    <div class="weather-item">
        ...
        <div id="lightning-container" v-if="current && lightning">
            <div class="updatedtime"><span><svg id="i-info" viewBox="0 0 32 32" width="6" height="6" fill="#9aba2f" stroke="#9aba2f" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%"> <path d="M16 14 L16 23 M16 8 L16 10"></path><circle cx="16" cy="16" r="14"></circle>
                </svg> {{current.date | now }} </span>
            </div>

<!--            <div class="lightningsvg">-->
<!--                <span><svg version="1.1" id="weather34_lightning_alert_notification" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 30" fill="current" xml:space="preserve">-->
...
<!--            -->
            <div id="lightning">
                ...
                <div class="lightningyear-mod2"> Strikes {{ current.date | month }} <orange> {{lightning.max.month.value }}</orange></div>
                <div class="lightningmonth-mod2"> Strikes {{ current.date | year}} <orange> {{lightning.max.year.value }}</orange></div>
            </div>
        </div>
    </div>
</template>
...
<style scoped>
    ...
    :root{--white:#ffffff;--light:#f5f5f5;--dark:#07090a;--dark-popup:#07090a;--dark-light:hsla(0, 0%, 0%, 0.251);--dark-toggle:#35393b;--dark-caption:rgba(66, 70, 72, 0.429);--black:#000000;--deepblue:#00adbd;--blue:#00adbd;--rainblue:#00adbd;--darkred:#703232;--deepred:#703232;--red:#d35f50;--yellow:#e6a241;--green:#90b22a;--orange:#d87040;--purple:#8680bc;--silver:#ecf0f3;--border-dark:#3d464d;--body-text-dark:#afb7c0;--body-text-light:#545454;--blocks:#e6e8ef;--modules:#1e1f26;--blocks-background:rgba(82, 92, 97, 0.19);--temp-5-10:#7face6;--temp-0-5:#00adbd;--temp0-5:#00adbd;--temp5-10:#9bbc2f;--temp10-15:#e6a241;--temp15-20:#f78d03;--temp20-25:#d87040;--temp25-30:#e64b24;--temp30-35:#cc504c;--temp35-40:hsl(4, 40%, 48%);--temp40-45:#be5285;--temp45-50:#b95c95;--font-color:grey;--bg-color:hsla(198, 14%, 14%, 0.19);--button-bg-color:hsla(198, 14%, 14%, 0.19);--button-shadow:inset 5px 5px 20px #0c0b0b,
    ...
    .button-dial-top-small {
        ...
        text-align: center;
        z-index: 5;
        background-image: linear-gradient(hsla(0, 0%, 33%, 0.1) 1px, transparent 1px), linear-gradient(to right, hsla(0, 0%, 33%, 0.1) 1px, transparent 1px);
