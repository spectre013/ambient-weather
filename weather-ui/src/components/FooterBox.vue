<template>
  <div class="weatherfooter-item">
    <div class="hardwarelogo1">
      <a
        href="http://ambientweather.com"
        alt="http://ambientweather.com"
        title="http://ambientweather.com"
      >
        <img
          src="img/ambient.png"
          alt="Ambient Weather"
          ...
          height="25px"
        />
        <div class="hardwarelogo1text">Ambient WS-2000</div>
      </a>
    </div>
    <div class="hardwarelogo2">
      <a
        href="https://weather34.com/homeweatherstation/"
        title="https://weather34.com/homeweatherstation/"
        target="_blank"
        ><br />
        <img
          src="img/weather34logo.svg"
          width="30px"
    ...
    <div class="footertext">
      ...
      >&nbsp;(<value>WS-2000 <maxred>Osprey</maxred></value
      >) Ambient Weather(<value><maxred>1.5</maxred></value
      >)&nbsp;
      <svg
        id="i-info"
        viewBox="0 0 32 32"
    ...
    <div class="footertext">
      ...
      >
        <path
          fill="#3b9cac"
          d="M320 8a320 320 0 0 0-101 624c16 3 22-7 22-16l-1-59c-89 19-108-38-108-38-14-37-35-47-35-47-29-20 2-19 2-19
