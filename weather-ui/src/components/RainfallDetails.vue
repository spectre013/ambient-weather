<template>
    <div class="weather-item">
        ...
        <span class="moduletitle">Rainfall Today (<valuetitleunit>in</valuetitleunit>)</span><br>
        <div id="rainfall" v-if="current">
            ...
            <div class="raincontainer1">
                <div class="raintoday1">{{ current.dailyrainin }}<sup><smallrainunita>in</smallrainunita></sup></div>
            </div>
            <div class="heatcircle">
                <div class="heatcircle-content">
                    ...
                    <div class="tempconverter1">
                        <div class="rainmodulehome">
                            <raiblue>{{ current.yearlyrainin }}</raiblue>
                            <smallrainunit2>in<smallrainunit2></smallrainunit2>
                            </smallrainunit2>
                        </div>
                    </div>
                </div>
                <div class="heatcircle2">
                    <div class="heatcircle-content">
                        ...
                        <div class="tempconverter1">
                            <div class="rainmodulehome">
                                <raiblue>{{ current.monthlyrainin }}</raiblue>
                ...
                <div class="heatcircle4">
                    <div class="heatcircle-content">
                        ...
                        <div class="tempconverter1">
                            <div class="rainmodulehome">
                                <raiblue>{{ current.dailyrainin }}</raiblue>
                                <smallrainunit2>in</smallrainunit2>
                            </div>
                        </div>
                    </div>
