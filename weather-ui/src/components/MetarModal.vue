    ...
    <div class="modal-backdrop">
        <div class="modal">
            <section class="modal-body">
                <div id="body" v-if="metar">
                    <div class="weather34darkbrowser" url="Nearby Airport Conditions"></div>
                    <main class="grid">
                        <article>
                            <div class="actualt">&nbsp;&nbsp; Current Conditions </div>
                            <div class="iconcondition"><img rel="prefetch" :src="getIcon" width="60px"></div>
                            <div class="icontext" v-html="conditions.desc"></div>
                            <br><br><br>
                            <div class="pressure">
                                <blue>Pressure</blue> <br>
                                {{ metar.barometer.hpa }} (hPa) -
                                {{ metar.barometer.hg }} (inHG)<br>
                                <blue>Visibility</blue> <br>
                                {{ metar.visibility.miles }} (mimiles) -
                                {{ metar.visibility.meters_float / 1000 }} (km)
                            </div>
                        </article>
                        <article>
                            <div class="actualt">&nbsp;&nbsp; Temperature </div>

                            <div class="metartempcontainer1">
                                <div :class="dynamicClass('temperature','fahrenheit')">{{ metar.temperature.fahrenheit }}<smalluvunit> &deg;F</smalluvunit>
                                </div>
                            </div>
                            <div class="tword">{{ metar.temperature.celsius }} &deg;C</div>
                            <div class="lotemp">

                                <div class="metardewcontainer1">
                                    <div :class="dynamicClass('dewpoint','fahrenheit')">{{ metar.dewpoint.fahrenheit }}<smalluvunit> &deg;F</smalluvunit>
                                    </div>
                                </div>
                                <div class="dewword">Dewpoint</div>

                                <div class="metarhumcontainer1">
                                    <div :class="hClass">{{ metar.humidity.percent }}<smalluvunit> &nbsp;%</smalluvunit>
                                    </div>
                                </div>
                        ...
                        <article>
                            <div class="actualw">&nbsp;&nbsp; Wind Speed</div>
                                <div class="metarwindcontainer1">
                                    <div :class="mphWindSpeedClass">{{ metar.wind.speed_mph }}<smalluvunit>&nbsp;mph</smalluvunit></div>
                                </div>
                                <div class="metarwindcontainer2">
                                    <div :class="ktsWindSpeedClass">{{ metar.wind.speed_kts }}<smalluvunit>&nbsp;kts</smalluvunit></div>
                                </div>
                                <div class="metarwindcontainer3">
                                    <div :class="kphWindSpeedClass">{{ (metar.wind.speed_mph * 1.66).toFixed(0)  }}<smalluvunit>&nbsp;km/h</smalluvunit></div>
                                </div>
                                <div class="metarwindcontainer4">
                                    <div :class="mpsWindSpeedClass">{{ metar.wind.speed_mps }}<smalluvunit>&nbsp;m/s</smalluvunit></div>
                                </div>
                        </article>
                        <article>
                            ...
                            <div class="metar34compass1">
                                <div class="directiontext">
                                    ...
                                    {{ metar.wind.degrees | degToCompass }}</div>
                                <div class="metar34compass-line1">
                                    <div class="thearrow2" v-bind:style="{transform:'rotate('+metar.wind.degrees+'deg)'}"></div>
                                </div>
                            </div>
                        </article>
                        <article>
                            <div class="actualt">&nbsp;&nbsp; Airport Data </div>
                            <stationid>KCOS</stationid><br>
                            <div class="lotemp">
                                Location <yellow>{{ metar.station.name }}</yellow>&nbsp;<br>
                        ...
                        <article>
                            ...
                            <div class="lotemp">
                                ...
                                </svg> Raw METAR is the most common format in the world for the transmission of observational weather
                                data. It is highly standardized through the International Civil Aviation Organization (ICAO), which
                                allows it to be understood throughout most of the world.</div>
                        </article>
                        <article>
                            ...
                            <div class="lotemp">
                                <svg id="i-info" viewBox="0 0 32 32" width="9" height="9" fill="none" stroke="currentcolor"
                                    ...
                                    <path d="M16 14 L16 23 M16 8 L16 10"></path>
                                    <circle cx="16" cy="16" r="14"></circle>
                                </svg> Data Provided by <a href="https://www.checkwx.com/weather/KCOS"
                                                           title="https://www.checkwx.com/weather/KCOS" target="_blank"><br><img src="img/checkwx.svg"
                                                                                                                                 width="130px" alt="https://www.checkwx.com/weather/KCOS"></a></div>
                        </article>
                        <article>
                            <div class="actualt">&nbsp;&nbsp; © Info</div>
                            <div class="lotemp">
                                <svg id="i-info" viewBox="0 0 32 32" width="9" height="9" fill="none" stroke="currentcolor"
                                     stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
                                    <path d="M16 14 L16 23 M16 8 L16 10"></path>
                                    <circle cx="16" cy="16" r="14"></circle>
                                </svg> CSS/SVG developed by <a href="https://weather34.com" title="weather34.com"
                                                                                target="_blank" style="font-size:9px;">weather34.com</a>
                                for use in the weather34 template ©2015-2019 <br><br>
                                <svg id="i-info" viewBox="0 0 32 32" width="9" height="9" fill="none" stroke="currentcolor"
                                     stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
                                    <path d="M16 14 L16 23 M16 8 L16 10"></path>
                                    <circle cx="16" cy="16" r="14"></circle>
                                </svg> Guide Info provided by <a href="https://en.wikipedia.org/wiki/METAR"
                                                                 title="https://en.wikipedia.org/wiki/METAR" target="_blank" style="font-size:9px;">Metar-Wikipedia
                            </a>
                            </div>
                        </article>
                    </main>
    ...
    export default {
        ...
        filters: {
            degToCompass: function(num) {
                ...
                let arr = ["North", "NNE", "NE", "ENE", "East", "ESE", "SE", "SSE", "South", "SSW", "SW", "WSW", "West", "WNW", "NW", "NNW"];
                return arr[(val % 16)];
            },
        ...
        methods: {
            ...
            dynamicClass: function(type,scale) {
                ...
                if ((scale === 'celcius' && this.metar[type][scale] >30) || (scale === 'fahrenheit' &&this.metar.temperature.fahrenheit >86)) {
                    return `metar${c}today30`;
                } else if ((scale === 'celcius' && this.metar[type][scale] >25) || (scale === 'fahrenheit' &&this.metar.temperature.fahrenheit >77)) {
                    return `metar${c}today25`;
                } else if ((scale === 'celcius' && this.metar[type][scale] >20) || (scale === 'fahrenheit' &&this.metar.temperature.fahrenheit >68)) {
                    return `metar${c}today20`;
                } else if ((scale === 'celcius' && this.metar[type][scale] >10) || (scale === 'fahrenheit' &&this.metar.temperature.fahrenheit >50)) {
                    return `metar${c}today10`;
                } else if ((scale === 'celcius' && this.metar[type][scale] >5) || (scale === 'fahrenheit' &&this.metar.temperature.fahrenheit >41)) {
                    return `metar${c}today5`;
                } else if ((scale === 'celcius' && this.metar[type][scale] >-50) || (scale === 'fahrenheit' &&this.metar.temperature.fahrenheit >-50)) {
...
<style scoped>
    ...
    .metar34compass1>.metar34compass-line1, .metar34compass>.metar34compass-line {
        right: 25px;
    ...
    .text1 {
        font-family: weathertext2, Arial;
        font-size: 20px;
        margin-left: 3px;
    }
    ...
    .metartemptoday0, .metartemptoday5, .metartemptoday10, .metartemptoday15, .metartemptoday20, .metartemptoday25, .metartemptoday30 {
        font-size: 1.1rem;
        padding-top: 0;
        color: #fff;
    ...
    .metartemptoday5 {
        background: rgba(144, 177, 42, 1.000)
    }

    .metartemptoday10 {
        background: rgba(230, 161, 65, 1.000)
    }

    .metartemptoday20 {
        background: rgba(255, 124, 57, 1.000)
    }
    ...
    .metardewtoday0, .metardewtoday5, .metardewtoday10, .metardewtoday20, .metardewtoday25, .metardewtoday30 {
        font-family: weathertext2, Arial, Helvetica, system;
        width: 4.5rem;
        height: 2.5rem;
        -webkit-border-radius: 3px;
    ...
    .metardewtoday0, .metardewtoday5, .metardewtoday10, .metardewtoday15, .metardewtoday20, .metardewtoday25, .metardewtoday30 {
        font-size: 1.1rem;
        padding-top: 0;
        color: #fff;
        border-bottom: 12px solid rgba(56, 56, 60, 1);
    ...
    .metarwindtoday0, .metarwindtoday5, .metarwindtoday10, .metarwindtoday20, .metarwindtoday25, .metarwindtoday30 {
        font-family: weathertext2, Arial, Helvetica, system;
        width: 5rem;
        height: 2.5rem;
        -webkit-border-radius: 3px;
    ...
    .metarwindtoday0, .metarwindtoday5, .metarwindtoday10, .metarwindtoday15, .metarwindtoday20, .metarwindtoday25, .metarwindtoday30 {
        font-size: 1.1rem;
        padding-top: 0;
        color: #fff;
    ...
    .metarwindtodaykts0, .metarwindtodaykts5, .metarwindtodaykts10, .metarwindtodaykts20, .metarwindtodaykts25, .metarwindtodaykts30 {
        font-family: weathertext2, Arial, Helvetica, system;
        width: 5rem;
        height: 2.5rem;
        -webkit-border-radius: 3px;
    ...
    .metarwindtodaykts0, .metarwindtodaykts5, .metarwindtodaykts10, .metarwindtodaykts15, .metarwindtodaykts20, .metarwindtodaykts25, .metarwindtodaykts30 {
        font-size: 1.5rem;
        padding-top: 0;
        color: #fff;
        border-bottom: 12px solid rgba(56, 56, 60, 1);
