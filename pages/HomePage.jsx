  ...
  return (
    <>
      ...
      <div className="grid">
        ...
        <div className="col-7"><WindCard wind={current.wind} hours={todayHours} /></div>
        ...
        <div className="col-7"><RainCard rain={current.rain} /></div>
        <div className="col-5"><MoonCard today={today} /></div>
      </div>
