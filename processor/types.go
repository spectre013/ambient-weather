...
// Record is the row that gets inserted once per minute into postgres.
type Record struct {
	...
	Lightningday      int       `json:"lightningday" db:"lightningday"`
	Lightninghour     int       `json:"lightninghour" db:"lightninghour"`
...
// SensorMessage is a loosely-typed view of every incoming JSON message.
// Fields are pointers so we can tell "absent" from "zero".
type SensorMessage struct {
	Time          string   `json:"time"`
	Model         string   `json:"model"`
	ID            int      `json:"id"`
	Channel       *int     `json:"channel,omitempty"`
	BatteryOK     *float64 `json:"battery_ok,omitempty"`
	BatteryMV     *float64 `json:"battery_mV,omitempty"`
	TemperatureC  *float64 `json:"temperature_C,omitempty"`
	Humidity      *int     `json:"humidity,omitempty"`
	WindDirDeg    *int     `json:"wind_dir_deg,omitempty"`
	WindAvgMS     *float64 `json:"wind_avg_m_s,omitempty"`
	WindMaxMS     *float64 `json:"wind_max_m_s,omitempty"`
	...
	StormDistance *float64 `json:"storm_dist_km,omitempty"`
	State         string   `json:"state,omitempty"`
	PM25          *float64 `json:"pm2_5_ug_m3,omitempty"`
	PM10          *float64 `json:"estimated_pm10_0_ug_m3,omitempty"`
}
